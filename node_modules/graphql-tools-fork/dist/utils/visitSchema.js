...
visitorOrVisitorSelector) {
    ...
    function callMethod(methodName, type) {
        ...
        visitors.every(function (visitorOrVisitorDef) {
            ...
            if (visitorOrVisitorDef instanceof SchemaVisitor_1.SchemaVisitor) {
                newType = visitorOrVisitorDef[methodName].apply(visitorOrVisitorDef, __spreadArrays([type], args));
            }
            else if (graphql_1.isNamedType(type) && (methodName === 'visitScalar' ||
    ...
    function visit(type) {
        if (type instanceof graphql_1.GraphQLSchema) {
            ...
            each_1.default(type.getTypeMap(), function (namedType, typeName) {
        ...
        if (type instanceof graphql_1.GraphQLInputObjectType) {
            ...
            if (newInputObject_1) {
                updateEachKey_1.default(newInputObject_1.getFields(), function (field) {
