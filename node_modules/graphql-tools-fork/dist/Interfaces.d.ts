...
export declare type MergedTypeResolver = (subschema: GraphQLSchema | SubschemaConfig, originalResult: any, context: Record<string, any>, info: IGraphQLToolsResolveInfo) => any;
...
export declare type MergedTypeMapping = Record<string, {
...
export declare type SchemaVisitorMap = {
    [key in VisitSchemaKind]?: TypeVisitor;
};
export declare type TypeVisitor = (type: GraphQLType, schema: GraphQLSchema) => GraphQLNamedType | null | undefined;
